...
'''
key_list = ['fqWbDS3X3pWLajkFO1ShBDdxQaNIXEu+9Q7mDDEQzQgKJs2r9eGfsKJ6//VkSUZt']
...
def bark(flag, message=None):
    ...
    bark_url = 'https://api.day.app/hPvgM5HbLDPwVEJZz4eAm3'
    global text1, text2
    if flag:
        ...
        text2 = '快看看'
    requests.post(bark_url + '/' + text1 + text2 + '?group=考试2000或3000')
